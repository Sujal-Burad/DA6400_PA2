...
name = 'Acrobot_type1_hyperparameter_tuning'
print("name = ", name)
...
sweep_id = wandb.sweep(sweep_config, project="dualing_dqn_type1_Acrobot_hyperparameter_finetuning_minimizing_regret")
